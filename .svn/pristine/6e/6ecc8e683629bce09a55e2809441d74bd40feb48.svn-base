...
<div class="content-wrapper">
 <section class="content-header">
     <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="popup_title">Add Static Pages</h1>
          </div>
          <!-- <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Static Pages</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
			  ...
			  {!! Form::open(array("enctype"=>"multipart/form-data","id"=>"demo-form","data-parsley-validate"=>"")) !!}
                <div class="card-body">
                  <div class="form-group">
					...
					{!!Form::text('page_title',null,['class'=>'form-control','placeholder'=>'Title','required'=>'']) !!}
					<a class="error_1">{{ $errors->first('page_title') }}</a>
                  </div>
				  <div class="form-group add-s-page">
                    <div>{!! Form::label('content','Content') !!}<span class="mandatory">*</span><br>				{!!Form::textarea('content',null,['class'=>'form-control','placeholder'=>'Content',"id"=>"editor1",'required'=>'']) !!}<br></div>
					<a class="error_1">{{ $errors->first('email') }}</a>
                  </div>
...
$(function () {
  $('#demo-form').parsley() 
   ...
   /* $('.ck-editor__main .ck-content p').text()); */

...
<div class="content-wrapper">
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="popup_title">Edit Language</h1>
          </div>
          <!--<div class="col-sm-6">
			  ...
			  {!! Form::open(array("enctype"=>"multipart/form-data","id"=>"demo-form","data-parsley-validate"=>"")) !!}
                <div class="card-body">
                  <div class="form-group">
					...
					{!!Form::text('name_in_eng',$language[0]->name_in_english,['class'=>'form-control','placeholder'=>'Name In English','required'=>'']) !!}
					<a class="error_1">{{ $errors->first('name_in_eng') }}</a>
                  </div>
               
                  <div class="form-group">
                    {!! Form::label('name_in_nat','Name in Native') !!}<span class="mandatory">*</span>
					{!!Form::text('name_in_nat',$language[0]->name_in_native,['class'=>'form-control','placeholder'=>'Name in Native','required'=>'']) !!}
					<a class="error_1">{{ $errors->first('name_in_nat') }}</a>
                  </div>
				  
				  <div class="form-group">
                    {!! Form::label('language_code','Language Code') !!}<span class="mandatory">*</span>
					{!!Form::text('language_code',$language[0]->language_code,['class'=>'form-control','placeholder'=>'Language Code','required'=>'']) !!}
				...
				<a href="{{url('language')}}">
				{!! Form::button('Cancel',['class'=>'btn btn-danger','data-toggle'=>"tooltip", 'data-placement'=>"bottom",'title'=>"Cancel"]) !!}</a>
                </div>
             {!! Form::close() !!}
            </div>

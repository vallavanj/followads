...
<div class="content-wrapper">
 <section class="content-header">
   <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="popup_title">Edit User Payment Method Details</h1>
          </div>
          <!--<div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit User Payment Method Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
			  ...
			  {!! Form::open(array("enctype"=>"multipart/form-data")) !!}
				...
				<div class="form-group">
					...
					<option value="{{$u_pay->user_payment_method_id}}" @if($u_pay->user_payment_method_id == $u_pay_method_detail[0]->user_payment_method_id){{'selected'}}@endif>{{$u_pay->channel_code}}</option>
					@endforeach
					</select>
                  ...
                  <div class="form-group">
					...
					{!!Form::text('detail_key',$u_pay_method_detail[0]->detail_key,['class'=>'form-control','placeholder'=>'Detail Key','required']) !!}
					<a class="error_1">{{ $errors->first('detail_key') }}</a>
                  </div>
				  <div class="form-group">
                    {!! Form::label('detail_value','Detail Value') !!}<span class="mandatory">*</span>
					{!!Form::text('detail_value',$u_pay_method_detail[0]->detail_value,['class'=>'form-control','placeholder'=>'Detail Value','required']) !!}

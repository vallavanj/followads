...
<div class="content-wrapper">
 <section class="content-header">
     <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="popup_title">Edit User Saved Advertisement</h1>
          </div>
          <!-- <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit User Saved Advertisement</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
			  ...
			  {!! Form::open(array("enctype"=>"multipart/form-data")) !!}
				...
				<div class="form-group">
					...
					@foreach($ads as $adv)
					<option value="{{$adv->advertisement_id}}" @if($u_saved_adv[0]->advertisement_id == $adv->advertisement_id){{'selected'}}@endif>{{$adv->advertisement_id}}</option>
					@endforeach
					</select>

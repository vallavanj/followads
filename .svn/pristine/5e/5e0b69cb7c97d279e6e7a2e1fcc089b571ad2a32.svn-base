...
<div class="content-wrapper">
 <section class="content-header">
     <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="popup_title">Edit Business Category</h1>
          </div>
          <!-- <div class="col-sm-6">
			  ...
			  {!! Form::open(array("enctype"=>"multipart/form-data")) !!}
                <div class="card-body">
                  <div class="form-group">
					...
					<option value="{{$buss->business_id}}" @if($buss->business_id == $buss_cat[0]->business_id){{'selected'}}@endif>{{$buss->name}}</option>
					@endforeach
					</select>
				  ...
				  <div class="form-group">
					...
					<option value="{{$categ->category_id}}" @if($categ->category_id == $buss_cat[0]->category_id){{'selected'}}@endif>{{$categ->category_name}}</option>
					@endforeach
					</select>

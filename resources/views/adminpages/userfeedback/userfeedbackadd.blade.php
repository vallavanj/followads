...
<div class="content-wrapper">
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="popup_title">Add User Feedback</h1>
          </div>
          <!--<div class="col-sm-6">
			  ...
			  {!! Form::open(array("enctype"=>"multipart/form-data")) !!}
                <div class="card-body">
                  <div class="form-group">
					...
					{!!Form::text('feedback_subject',null,['class'=>'form-control','placeholder'=>'Feedback Subject','required']) !!}
					<a class="error_1">{{ $errors->first('feedback_subject') }}</a>
                  </div>
				 <div class="form-group">
                    {!! Form::label('feedback_description','Feedback Description') !!}
					{!!Form::textarea('feedback_description',null,['class'=>'form-control','placeholder'=>'Feedback Description','cols'=>5,'rows'=>2]) !!}
					<a class="error_1">{{ $errors->first('feedback_description') }}</a>
                  </div>
				  <div class="form-group">
                    {!! Form::label('feedback_status','Feedback Status') !!}
					{!!Form::text('feedback_status',null,['class'=>'form-control','placeholder'=>'Feedback Status']) !!}

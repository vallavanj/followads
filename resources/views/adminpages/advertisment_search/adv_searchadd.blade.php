...
<div class="content-wrapper">
 <section class="content-header">
     <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="popup_title">Add Advertisement Search</h1>
          </div>
          <!-- <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Advertisement Search</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                  <div class="form-group">
				   ...
				   <div class="form-group">
					...
					{!!Form::text('search_term',null,['class'=>'form-control','placeholder'=>'Search Terms','required']) !!}

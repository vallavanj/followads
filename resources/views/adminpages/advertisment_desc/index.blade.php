		...
		@endif
          ...
          <div class="card">
            <div class="card-header">
			  ...
			  <a href="#" onclick="call_add_page()" style="font-color:#000000 !important; text-decoration:none;"><button class="btn btn-success" >Add Advertisement Description</button></a>
            </div>
            <!-- /.card-header -->
			...
			?>
                <tr>
				  ...
				  <i title="Status" id="status_{{$ads->advertisement_descriptions_id}}" data="{{$ads->advertisement_descriptions_id}}" class="status_checks btn btn_w {{$status_class}}"><span class='{{$status}}'></span></i></a>
				  <a title="View" class="btn btn-outline-primary btn-sm" href="javascript:void(0)" onclick = "single_view('{{$ads->advertisement_descriptions_id}}')"><i class="fa fa-eye fa-lg" aria-hidden="true" ></i></a>
				  <a href="#" class="btn btn-outline-primary btn-sm" onclick="call_page('{{encrypt($ads->advertisement_descriptions_id)}}')"><i class="fa fa-edit fa-lg" aria-hidden="true"></i></a>
				  <a href="{{url('adv_descdelete/'.encrypt($ads->advertisement_descriptions_id))}}" class="btn btn-outline-primary btn-sm"><li  class="fa fa-trash fa-lg" onclick= 'return doconfirm()'></li></a></td>
                </tr>
				@endforeach
                </tbody>
               <?PHP /* <tfoot>

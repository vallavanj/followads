...
<div class="content-wrapper">
 <section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1  class="popup_title">Add Advertisement Category</h1>
          </div>
            <!--<div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Advertisement Category</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
			  ...
			  {!! Form::open(array("enctype"=>"multipart/form-data")) !!}
                <div class="card-body">
                  <div class="form-group">
					...
					<option value="{{$busi->advertisement_id}}">{{$busi->advertisement_id}}</option>
					@endforeach
					</select>

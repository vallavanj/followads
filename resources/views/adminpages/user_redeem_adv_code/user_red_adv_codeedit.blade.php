...
<div class="content-wrapper">
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="popup_title">Edit Redeemed Advertisement Code</h1>
          </div>
         <!-- <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit User Redemmed Advertisement Code</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
			  ...
			  {!! Form::open(array("enctype"=>"multipart/form-data","id"=>"demo-form","data-parsley-validate"=>"")) !!}
				...
				<div class="form-group">
					...
					<option value="{{$adv->advertisement_offer_code_id}}" @if($u_r_adv_code[0]->advertisement_offer_code_id == $adv->advertisement_offer_code_id){{'selected'}}@endif>{{$adv->offer_code}}</option>
					@endforeach
					</select>

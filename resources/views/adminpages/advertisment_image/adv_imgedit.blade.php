...
<div class="content-wrapper">
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="popup_title">Edit Advertisement Image</h1>
          </div>
         <!-- <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Advertisement Image</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
			  ...
			  {!! Form::open(array("enctype"=>"multipart/form-data")) !!}
                <div class="card-body">
				  ...
				  <div class="form-group">
					...
					@foreach($lang as $lan)
					<option value="{{$lan->language_id}}" @if($lan->language_id == $adv_img[0]->language_id){{'selected'}}@endif>{{$lan->name_in_english}}</option>
					@endforeach
					</select>
					<a class="error_1">{{ $errors->first('language_name') }}</a>
                  </div>
				  <div class="form-group">
				  <img src="{{url('advertisement_images/uploads/doc/'.$adv_img[0]->advertisement_image_id.'/'.$adv_img[0]->image_url)}}" width="50px" height="50px" class="img-circle">
				  </div>
				  <div class="form-group">
					{!! Form::label('ads_image','Advertisement Image') !!}

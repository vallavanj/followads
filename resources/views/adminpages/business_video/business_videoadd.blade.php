...
<div class="content-wrapper">
 <section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="popup_title">Add Business Videos</h1>
          </div>
            <!--<div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
			  <li><i class="nav-icon fa fa-dashboard"></i></li>
			  <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
              <li class="breadcrumb-item"><a href="{{url('store_image')}}">Manage Business Videos</a></li>
              <li class="breadcrumb-item active">Add Business Videos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
			  ...
			  {!! Form::open(array("enctype"=>"multipart/form-data")) !!}
                <div class="card-body">
				  ...
				  <div class="form-group">
					{!! Form::label('business_image','BusinessVideo') !!}<span class="mandatory">*</span>
                    <div class="input-group">
                      <div class="custom-file">
						{!!Form::file('business_video',['class'=>'custom-file-input','id'=>'exampleInputFile','required',"accept"=>"video/*"]) !!}

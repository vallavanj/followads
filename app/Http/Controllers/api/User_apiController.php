   ...
   public function user_register(Request $request)
	{
		...
		if($user_reg_verify->isEmpty())
		{
					...
					/* echo rand(10000,1000);exit; */
						...
						$sendsms= file_get_contents("http://teleduce.corefactors.in/sendsms/?key=92051b10-d87b-438e-89ae-0e3deac35f76&from=FLWADS&route=3&to=".$mobile_number."&text=<%23>".$otp." Use as your login one time password. OTP is confidential. FollowAds never call you asking for OTP. AoSqbsgCTal");						
						$user = array(
		...
		else
		{
			...
			{
				$otp = $u_d->otp;
				$mobile_number = $u_d->mobile_number;
			}
